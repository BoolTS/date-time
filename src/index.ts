...
export const add = (time: Date | string | number, value: number, unit: ETimeUnit = ETimeUnit.day): Date => {
...
export const splitTime = (params?: { ["dateData"]: Date; ["isUTC"]: boolean; ["isString"]: boolean }) => {
    ...
    if (!isUTC) {
        ...
        const milliseconds =
            dateData.getUTCMilliseconds() < 10
                ? !isString
